...
trait ContentLoaderTrait
{
     ...
     */
    private function doParseRoute(RouteCollection $collection, string $name, array $config, string $path): void
    {
     ...
     */
    private function doParseImport(RouteCollection $collection, array $config, string $path, string $file): void
    {
     ...
     */
    private function doValidate(mixed $config, string $name, string $path): void
    {
        if (!\is_array($config)) {
    ...
    private function loadContent(RouteCollection $collection, array $config, string $path, string $file): void
    {
        foreach ($config as $name => $config) {
            ...
            foreach ($config as $name => $config) {
                $this->doValidate($config, $when, $path);
